...
const App = () => {
  ...
  const initArray = Array(anecdotes.length).fill(0);
  const [voted, setVoted] = useState(initArray);
  ...
  const indexOfMax = voted.indexOf(max);
  ...
  return (
    <div>
      ...
      <Anecdotes anecdotes={anecdotes[indexOfMax]} votes={max} />
    </div>
  );
};
